...
@Repository
public class MortgageDynamicArray { 
	...
	public void addAt(int index, Mortgage mortgage) 
    { 
	...
	public boolean isAlreadyPresentInMortgageDynamicArray(MortgageDynamicArray mortgageDynamicArray, Mortgage mortgage) {
		boolean flag = false;
	...
	//public static void main(String[] args) { 
		 ...
		 * + mortgageDynamicArray.size); System.out.println("No of elements in array: " + mortgageDynamicArray.count);
		 * 
		 * // shrinkSize of array mortgageDynamicArray.shrinkSize();
		 * 
		 * // print all array elements System.out.println("Elements of array "+
		 * "after shrinkSize of array:"); for (int i = 0; i < mortgageDynamicArray.size; i++) {
		 * System.out.print(mortgageDynamicArray.array[i] + " "); } System.out.println();
		 * 
		 * // print size of array and no of element System.out.println("Size of array: "
		 * + mortgageDynamicArray.size); System.out.println("No of elements in array: " + mortgageDynamicArray.count);
		 * 
		 ...
		 * " add an element at index 1:"); for (int i = 0; i < mortgageDynamicArray.size; i++) {
		 ...
		 * (int i = 0; i < mortgageDynamicArray.size; i++) { System.out.print(mortgageDynamicArray.array[i] + " "); }
		 * 
		 * System.out.println();
		 * 
		 * // print size of array and no of element System.out.println("Size of array: "
		 ...
		 * for (int i = 0; i < mortgageDynamicArray.size; i++) { System.out.print(mortgageDynamicArray.array[i] + " "); }
		 * System.out.println();
		 * 
		 * // print size of array and no of element System.out.println("Size of array: "
		 * + mortgageDynamicArray.size); System.out.println("No of elements in array: " + mortgageDynamicArray.count);
